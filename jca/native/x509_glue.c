 ...
 *  ******************************/
JNIEXPORT jbyteArray JNICALL Java_org_crypthing_security_x509_NharuPublicKey_nhixGetPublicKeyInfo
(
	JNIEnv *env,
	_UNUSED_ jclass ignored,
	jlong handle
...
JNIEXPORT jint JNICALL Java_org_crypthing_security_x509_NharuPublicKey_nhixGetPublicKeyType
(
	JNIEnv *env,
	_UNUSED_ jclass ignored,
	jlong handle
 ...
 *  ******************************/
JNIEXPORT jlong JNICALL Java_org_crypthing_security_x509_NharuRSAPublicKey_nhixGetPublicKeyHandle
(
	_UNUSED_ JNIEnv *env,
	_UNUSED_ jclass ignored,
	jlong handle
...
JNIEXPORT jbyteArray JNICALL Java_org_crypthing_security_x509_NharuRSAPublicKey_nhixGetRSAKeyModulus
(
	JNIEnv *env,
	_UNUSED_ jclass ignored,
	jlong handle
...
JNIEXPORT jbyteArray JNICALL Java_org_crypthing_security_x509_NharuRSAPublicKey_nhixGetRSAKeyPublicExponent
(
	JNIEnv *env,
	_UNUSED_ jclass ignored,
	jlong handle
