...
REM CREATES A VERSION FILE FOR SHARED LIBRARY
REM %~1: VERSION NUMBER
REM %~2: DIRECTORY WHERE TO CREATE C FILE
REM REQUIRES AN ANT build.number FILE IN CURRENT DIRECTORY
REM BUILD INCREMENT IS IMPLEMENTED BY ANT DUE TO ENSURE EQUALITY TO JAVA
