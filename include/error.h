...
/**
 * @brief PKCS #12 Parsing Errors
 * 
 */
#define NH_PFX_ERROR				(NH_ISSUE_ERROR + 16)
#define NH_PFX_INVALID_ENCODING_ERROR	(NH_PFX_ERROR + 1)
#define NH_PFX_WRONG_VERSION_ERROR		(NH_PFX_ERROR + 2)
#define NH_PFX_UNSUPPORTED_TYPE_ERROR	(NH_PFX_ERROR + 3)
#define NH_PFX_UNSUPPORTED_HASH_ERROR	(NH_PFX_ERROR + 4)
...
#define NH_PFX_UNSUPPORTED_KEY_ERROR	(NH_PFX_ERROR + 9)
#define NH_PFX_UNSUPPORTED_IV_ERROR		(NH_PFX_ERROR + 10)
