...
typedef NH_METHOD(NH_RV, NH_TBSCL_SET_AKI)(_INOUT_ NH_CERTLIST_ENCODER_STR*, _IN_ NH_OCTET_SRING*);
struct NH_CERTLIST_ENCODER_STR
{
	NH_ASN1_ENCODER_HANDLE	hTBS;				/**< ASN.1 encoder */
