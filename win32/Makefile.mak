...
# # # # # # # # # # #
DIST_DIR     = C:\Users\nobody\dev\nharu\dist
OPENSSL      = $(DIST_DIR)\$(TARGET)\openssl
LIBIDN       = $(DIST_DIR)\$(TARGET)\idn
HOME         = C:\Users\nobody\dev\nharu
JAVA_HOME    = C:\Users\nobody\jdk-7
VERSION      = 1.3.0
...
MAVEN_ARGS  = -D install.dir=$(OUT) -D bin.dir=$(OBJ) -D jar.version=$(VERSION)
...
PREPARE:
	...
	!IF NOT EXIST "$(OBJ)test"  MKDIR "$(OBJ)\test"
...
INSTALL:
	...
	!COPY /Y "$(OUT)\nharujca-$(VERSION).jar" "$(PREFIX)\libs"
	!ENDLOCAL
